...
func getattrHandle(tConn *TcfsConn, msgbuf []byte) {
	...
	binary.BigEndian.PutUint32(buf[16:20], uint32(stat.Mode))
	...
	binary.BigEndian.PutUint32(buf[36:40], uint32(stat.Atimespec.Sec))
	binary.BigEndian.PutUint32(buf[40:44], uint32(stat.Mtimespec.Sec))
	binary.BigEndian.PutUint32(buf[44:48], uint32(stat.Ctimespec.Sec))
	tConn.Write(buf[:48])
}
